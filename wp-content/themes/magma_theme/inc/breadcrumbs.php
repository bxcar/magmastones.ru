...
class Kama_Breadcrumbs {
	...
	static $args = array(
		...
		'title_patt'      => '<span class="kb_title breadcrumb-item active">%s</span>', // шаблон для последнего заголовка. Если включено: show_post_title или show_term_title
	...
	function get_crumbs( $sep, $l10n, $args ){
		...
		$arg->sep = '<sep class="kb_sep">'. $arg->sep .'</sep>'; // дополним
		...
		if(1){
			...
			if( ! $mark ) $mark = array(
				'wrappatt'  => '<nav class="breadcrumb">%s</nav>',
				'linkpatt'  => '<a href="%s" class="breadcrumb-item">%s</a>',
				'sep_after' => '',
			);
			// rdf
